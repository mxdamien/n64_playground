...
void on_position_updated(const ECS *const ecs, Entity e)
{
}

void on_model_updated(const ECS *const ecs, Entity e)
{
...
{
  ecs_register_position_callback(ecs, on_position_updated);
  ecs_register_model_callback(ecs, on_model_updated);
}
